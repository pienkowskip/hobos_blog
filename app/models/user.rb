class User < ActiveRecord::Base
  ...
  lifecycle do
    ...
    create :invite,
           ...
           :new_key => true,
           :become => :invited do
       UserMailer.invite(self, lifecycle.key).deliver_now
    end
  ...
  def validate_password
    return unless new_password_required? && (password.nil? || password.length<6)
    errors.add(:password, I18n.t('hobo.messages.validate_password', :default => 'must be at least 6 characters long'))
  end
end
